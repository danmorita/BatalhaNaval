...
public class Copia {
	 ...
	 */
	public static int posicaoBarco[][];//posi��o dos bacos
	private JFrame frame;
	public static  Botao tabuleiro[][];
	public static Botao tabuleirobot[][];
	private Botao btBarco2H;
	private Botao btBarco2V;
	private Botao btBarco3H;
	private Botao btBarco3V;
	private Botao btBarco1HV;
	private JButton atknpcbot;
